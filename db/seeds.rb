packs=[
  ...
  ["Ambience", 1, "A collection of ambience recorded with a Zoom h2. Great for adding natural ambience to all your productions!", "https://sound-pantry-dev.s3.amazonaws.com/ambience.png"],
